...
import { Heart, MessageSquare, Bookmark, Calendar, Clock } from "lucide-react";
...
export default function BlogPost({ id }: { id: string }) {
  ...
  return (
    <div className="w-full">
      <header className="bg-muted py-12 h-[350px] md:h-[400px] relative">
        <div className="container mx-auto p-8 absolute bottom-0 left-1/2 transform -translate-x-1/2">
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <div className="text-center">
              ...
              <p className="text-xs font-medium">{post.author.role}</p>
            </div>
          </div>
        </div>
      </header>
      <main className="pt-0 grid md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-2 lg:col-span-3">
          <div className="pb-12 flex items-center justify-between">
            <div className="hidden sm:flex sm:flex-row gap-8 text-sm">
